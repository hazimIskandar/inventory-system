...
class RawMaterialsControllerTest < ActionController::TestCase
  ...
  test "should create raw_material" do
    assert_difference('RawMaterial.count') do
      post :create, raw_material: { name: @raw_material.name, perniagaan_id: @raw_material.perniagaan_id, quantity: @raw_material.quantity }
    end
  ...
  test "should update raw_material" do
    patch :update, id: @raw_material, raw_material: { name: @raw_material.name, perniagaan_id: @raw_material.perniagaan_id, quantity: @raw_material.quantity }
    assert_redirected_to raw_material_path(assigns(:raw_material))
  end
